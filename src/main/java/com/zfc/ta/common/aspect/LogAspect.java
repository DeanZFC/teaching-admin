package com.zfc.ta.common.aspect;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.zfc.ta.common.annotation.SysLog)")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        SysLog mylog = method.getAnnotation(com.zfc.ta.common.annotation.SysLog.class);
        if(mylog != null){
            //注解上的描述
